    ...
    PlayerService.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.DatabaseProvider.getConnection()];
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.getRepository(player_1.Player).findOneById(id)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, index_1.DatabaseProvider.getConnection()];
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.getRepository(player_1.Player).save(newPlayer)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.getRepository(player_1.Player).find()];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        repository = connection.getRepository(player_1.Player);
                        return [4 /*yield*/, repository.findOneById(player.id)];
                    case 2:
                        entity = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.getRepository(player_1.Player).removeById(id)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
