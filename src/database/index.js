...
var DatabaseProvider = /** @class */ (function () {
    ...
    DatabaseProvider.configure = function (dbConfiguration) {
        DatabaseProvider.configuration = dbConfiguration;
    };
    DatabaseProvider.getConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, type, host, port, username, password, database, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = DatabaseProvider.configuration, type = _a.type, host = _a.host, port = _a.port, username = _a.username, password = _a.password, database = _a.database;
                        _b = DatabaseProvider;
